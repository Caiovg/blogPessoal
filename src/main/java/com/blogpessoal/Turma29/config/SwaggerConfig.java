...
public class SwaggerConfig {
	...
	return new Docket(DocumentationType.SWAGGER_2)
		...
		.basePackage("com.blogpessoal.Turma29.controller"))
	...
	return new ApiInfoBuilder()
		...
		.licenseUrl("http://localhost:8081/swagger-ui/")
		.contact(contact())
		.build();
	}
	
	private static Contact contact() {
		return new Contact("Caio Vinicius Gonçalves",
		"https://github.com/Caiovg/blogPessoal",

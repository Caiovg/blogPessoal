...
public class SwaggerConfig {
	...
	private static Contact contact() {
		return new Contact("Caio Vinicius Gonçalves", "https://github.com/Caiovg/blogPessoal",
				"caioviniciusg.1000@gmail.com");
	}
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder().title("API - Blog Pessoal").description("Projeto API Spring - Blog Pessoal")
				...
				.licenseUrl("https://github.com/Caiovg/blogPessoal").contact(contact()).build();
	}
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.blogpessoal.Turma29.controller"))
